/**
 * Deployed-app half of the platform PWA chrome. Wired from `src/start.ts`
 * request middleware (Cloudflare Worker / TanStack Start). Local `vite dev`
 * also serves this chrome via `grokPwaPlugin()` in vite.config.ts.
 *
